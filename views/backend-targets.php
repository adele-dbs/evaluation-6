        ...
        if(isset($_POST['update'])){
          ...
          <form action="" method="POST">
            <div class="form-group">
              ...
              <input type="text" name="updatefirstname" class="form-control" id="updatefirstname" value="<?=$targetById->getFirstName()?>">
              <label for="updatelastname">Nom : </label>
              <input type="text" name="updatelastname" class="form-control" id="updatelastname" value="<?=$targetById->getLastName()?>">
              <label for="updatecodename">Nom de code : </label>
              <input type="text" name="updatecodename" class="form-control" id="updatecodename" value="<?=$targetById->getCodeName()?>">
              <label for="updatebirthday">Date de naissance : </label>
              <input type="date" name="updatebirthday" class="form-control" id="updatebirthday" value="<?=$targetById->getBirthday()?>">
              <label for="updatenationality">Nationnalité : </label>
              <input type="text" name="updatenationality" class="form-control" id="updatenationality" value="<?=$targetById->getNationality()?>">
