...
INSERT INTO `contacts` VALUES (1,'Kévin','STRICH','2000-10-21','Le loup','irlandaise'),(2,'Marco','Ruiz','2000-10-22','La souris','espagole'),(3,'Louise','MAOUSE','2000-10-23','La loutre','française'),(4,'Paul','LIMON','2000-10-23','Lim','française'),(6,'test','test','2022-04-21','testtestt','test'),(7,'testtest','test','2022-04-28','desestdde','ddd');
...
INSERT INTO `hideouts` VALUES (1,'Pub','1 street Pink ',0,'Dublin','Irlande','maison'),(2,'Mirador','1 rue Rouge ',0,'Paris','France','appartement'),(3,'El Piso','1 calle Verde ',0,'Madrid','Espagne','maison'),(4,'La Bergerie','1 rue de Londres',0,'Paris','France','appartement');
...
INSERT INTO `mission_contact` VALUES (1,3),(1,4),(2,1);
...
INSERT INTO `mission_hideout` VALUES (1,2),(1,4),(2,1);
...
INSERT INTO `particularities` VALUES (1,'Espionnage'),(2,'Sabotage'),(3,'Enlèvement'),(4,'Assassinat'),(5,'Infiltration'),(6,'Exfiltration'),(44,'testttt');
...
INSERT INTO `users` VALUES (1,1,'Paul','JOO','paul.joo@kgb.com','$2y$10$1nMwg1dUF8ZjtkwWqd9fje7lrWjDfiVS6bJpqfrrnuws9X.C3zyxy','2000-10-21'),(2,2,'Marie','LUUN','marie.luun@kgb.com','$2y$10$2cahdxATclHjLJy/9WCjLO5dHLoZjFDXTQ1lbeHNcEyfYrMQZkdo.','2000-10-21'),(3,1,'Anne','DO','anne.do@kgb.fr','$2y$10$uruSliQm/L8YTJiAMCyLT.FI/XMYju4wAl6fqqVeFRh0vjCTu3RKa','2022-02-12');
...
-- Dump completed on 2022-04-10 14:45:35
